...
const PrivacyPolicy = () => (
  <div className="max-w-4xl mx-auto px-4 py-10 text-gray-100">
    <h1 className="text-3xl font-bold mb-6">
      <Link
        to="https://merchant.razorpay.com/policy/QxeUaH7am5M6Wk/privacy"
        target="_blank"
    ...
    <p className="mb-4">
      At DevConnector, accessible from https://devconnector.info/, one of our
      main priorities is the privacy of our visitors. This Privacy Policy
      document contains types of information that is collected and recorded by
      DevConnector and how we use it.
    </p>
    <h3 className="text-xl font-semibold mt-6 mb-2">Information We Collect</h3>
    <ul className="list-disc list-inside mb-4">
      <li>
        Personal information such as name, email, contact number (only when you
        submit a form).
      </li>
      <li>Usage data like browser type, IP address, pages visited, etc.</li>
    </ul>
    ...
    <p className="mb-4">
      We implement strong security measures to protect your data and ensure its
      confidentiality.
    </p>
